...
teamwins['team'] = teamwins['team'].str.replace('E Washingtnngton', 'E Washingtn')
teamwins['team'] = teamwins['team'].str.replace('Western Michigan', 'W Michigan')
teamwins['team'] = teamwins['team'].str.replace('Georgia Stte', 'Georgia St')
teamwins['team'] = teamwins['team'].str.replace('San Diego Stte', 'San Diego St')
teamwins['team'] = teamwins['team'].str.replace('Pennsylvania', 'U Penn')
teamwins['team'] = teamwins['team'].str.replace('Morehead Stte', 'Morehead St')
teamwins['team'] = teamwins['team'].str.replace('Cleveland Stte', 'Cleveland St')
teamwins['team'] = teamwins['team'].str.replace('Colorado Stte', 'Colorado St')
teamwins['team'] = teamwins['team'].str.replace('Norfolk Stte', 'Norfolk St')
teamwins['team'] = teamwins['team'].str.replace('Boise Stte', 'Boise St')
...
teamwins.loc[teamwins['team'] == 'Pennsylvania', 'team'] = 'U Penn'
teamwins.loc[teamwins['team'] == 'Penn ', 'team'] = 'U Penn'
teamwins['team'] = teamwins['team'].str.replace(r'Florida \(2OT\)', 'Florida')
teamwins['team'] = teamwins['team'].str.replace(r'Miami \(Ohio\)', 'Miami (OH)')
teamwins['team'] = teamwins['team'].str.replace(r'Rob Morris \(OT\)', 'Rob Morris')
teamwins['team'] = teamwins['team'].str.replace(r'Loyola \(Md\.\)', 'Loyola-MD')
teamwins['team'] = teamwins['team'].str.replace(r'Penn', 'U Penn')
teamwins['team'] = teamwins['team'].str.replace(r'Texas \(OT\)', 'Texas')
teamwins['team'] = teamwins['team'].str.replace(r'St\. Josephs', 'St Josephs')
...
teamwins['team'] = teamwins['team'].str.replace('U Penn St', 'Penn St')
